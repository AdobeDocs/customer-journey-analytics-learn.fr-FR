---
title: Data Mirror - Synchroniser automatiquement les données de l’entrepôt de données avec CJA
...
# Data Mirror pour [!DNL Customer Journey Analytics] : synchroniser les données de Snowflake, BigQuery et Databricks avec CJA
