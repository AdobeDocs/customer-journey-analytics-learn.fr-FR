---
title: Storytelling de données - Générer des présentations en diapositives
description: Découvrez la puissante fonctionnalité de Storytelling de données d’Adobe Customer Journey Analytics qui utilise l’IA générative pour transformer vos projets Analysis Workspace en présentations PowerPoint professionnelles.
...
Pour plus d’informations, consultez la [documentation](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/curate-share/generate-slides){target="_blank"} de Content Analytics.
