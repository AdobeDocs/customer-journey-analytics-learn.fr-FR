...
+ [Créer des visualisations sur plusieurs Canaux](/help/creating-cross-channel-visualizations-in-customer-journey-analytics.md)
+ [Attribution entre Canaux](/help/cross-channel-attribution-in-customer-journey-analytics.md)
+ [Présentation des mesures calculées dans le Customer Journey Analytics](/help/introduction-to-calculated-metrics-in-customer-journey-analytics.md)
+ [Déplacer vos mesures calculées d’Adobe Analytics vers Customer Journey Analytics](/help/moving-your-calculated-metrics-from-adobe-analytics-to-customer-journey-analytics.md)
