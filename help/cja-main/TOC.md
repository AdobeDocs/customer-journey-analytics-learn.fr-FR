...
+ Serveur MCP distant {#remote-mcp-server}
  + [Présentation du serveur MCP distant pour CJA](remote-mcp-server/remote-mcp-server-for-cja-overview.md)
  + [Le serveur MCP distant pour CJA en action](remote-mcp-server/remote-mcp-server-for-cja-in-action.md)
...
+ Connexions {#connections}
  ...
  + [Synchroniser avec l’entrepôt de données externe](connections/cja-data-mirror-sync-external-platforms.md)
  ...
  + [Prise en main d’Audience Analysis](connections/get-started-with-audience-analysis.md)
+ Identification des visiteurs et visiteuses {#visitor-id}
  ...
  + [Valider les données et la qualité de l’assemblage à l’aide de l’aperçu](visitor-id/validate-identity-stitching-quality.md)
  + [Activation et validation du groupement](visitor-id/stitching-enablement-and-validation.md)
...
+ Vues des données {#data-views}
  ...
  + Champs dérivés{#derived-fields}
    ...
    + [Utiliser la fonction mathématique](data-views/derived-fields/use-the-math-function-in-derived-fields.md)
    + [Utiliser la fonction Suivant ou Précédent](data-views/derived-fields/use-the-next-previous-function-in-derived-fields.md)
    + [Personnaliser la profondeur de l’événement](data-views/derived-fields/customize-event-depth-in-derived-fields.md)
    + [Utiliser le typecasting](data-views/derived-fields/use-typecasting-in-derived-fields.md)
    + [Utiliser Mathématiques de date pour calculer le temps entre les événements](data-views/derived-fields/use-date-math-to-calculate-time-between-events.md)
+ Agent Data Insights {#data-insights-agent}
  ...
  + [Utiliser l’agent Data Insights](data-insights-agent/use-the-data-insights-agent.md)
  + [Intégration avec Microsoft 365 Copilot](data-insights-agent/data-insights-with-marketing-agent-365copilot.md)
+ Analysis Workspace {#analysis-workspace}
  + Projets Workspace {#workspace-projects}
    ...
    + [Commentaires sur Workspace](analysis-workspace/workspace-projects/workspace-commenting.md)
  ...
  + Panneaux {#panels}
    + [Ajouter des composants au panneau à structure libre](analysis-workspace/panels/add-components-to-the-freeform-panel.md)
    + [Construire le panneau d’attribution](analysis-workspace/panels/build-the-attribution-panel.md)
    ...
    + [Utiliser le panneau Aperçu rapide](analysis-workspace/panels/use-the-quick-insights-panel.md)
  + Modèles {#templates}
    + [Utiliser des modèles](analysis-workspace/templates/use-templates.md)
    + [Créer des modèles personnalisés](analysis-workspace/templates/create-custom-templates.md)
  + Tableaux à structure libre {#freeform-tables}
    + [Utiliser des classifications intégrées](analysis-workspace/freeform-tables/in-line-classifications-for-cja.md)
    + [Explorer les paramètres de ligne et de colonne dans les tableaux à structure libre](analysis-workspace/freeform-tables/cja-explore-row-and-column-settings-in-freeform-tables.md)
  + Visualisations {#visualizations}
    + [Obtention de données dans les visualisations](analysis-workspace/visualizations/getting-data-into-visualizations.md)
    + [Utilisation des listes déroulantes de composants dans Workspace](analysis-workspace/visualizations/component-dropdowns-in-analysis-workspace.md)
    ...
    + [Plusieurs colonnes de dimensions dans les tableaux à structure libre](analysis-workspace/visualizations/multiple-dimension-columns-in-freeform-tables.md)
    + [Ajouter des visualisations en ligne](analysis-workspace/visualizations/line-visualization.md)
    + [Ajout de tendances aux visualisations en ligne](analysis-workspace/visualizations/cja-add-trendlines-to-line-visualizations.md)
    + [Utilisation de la fonction moyenne cumulée pour le lissage des mesures](analysis-workspace/visualizations/cja-use-the-cumulative-average-function-for-metric-smoothing.md)
    + [Ajout et configuration de la visualisation des cartes](analysis-workspace/visualizations/configure-and-use-the-map-visualization.md)
    + [Ajouter des visualisations de résumé](analysis-workspace/visualizations/use-summary-visualizations.md)
    + [Ajouter des visualisations de texte](analysis-workspace/visualizations/add-text-visualizations.md)
    + [Lien interne ou externe à votre projet](analysis-workspace/visualizations/cja-link-inside-or-outside-of-your-project.md)
    + [Ajout de visualisations de dispersion](analysis-workspace/visualizations/use-scatterplot-visualizations.md)
    + [Ajout de visualisations de carte arborescente](analysis-workspace/visualizations/add-treemap-visualizations.md)
    + [Création de visualisations 100 % empilées](analysis-workspace/visualizations/create-stacked-visualizations.md)
    + [Personnalisation des légendes des visualisations](analysis-workspace/visualizations/cja-customize-visualization-legends.md)
    + [Définir la granularité des visualisations](analysis-workspace/visualizations/cja-set-granularity-for-visualizations.md)
  ...
  + Calendrier et périodes {#calendar-and-date-ranges}
    + [Utilisation des calendriers et des dates dans Analysis Workspace](analysis-workspace/calendar-and-date-ranges/cja-calendar-and-dates-in-analysis-workspace.md)
    + [Application de périodes réutilisables dans votre projet](analysis-workspace/calendar-and-date-ranges/cja-apply-reusable-date-ranges-in-your-project.md)
    + [Utilisation de périodes et de comparaisons](analysis-workspace/calendar-and-date-ranges/cja-use-date-ranges-and-comparisons.md)
...
+ Analyse guidée {#guided-analysis}
  + [Utiliser l’analyse guidée dans Workspace](guided-analysis/guided-analysis-in-workspace.md)
...
+ Composants {#components}
  + Segments {#filters}
    + [Vue d’ensemble des segments](components/filters/introduction-to-filters-in-cja.md)
    + [Créer un segment rapide](components/filters/create-a-quick-filter.md)
    + [Créer des segments cross-canal](components/filters/creating-cross-channel-filters-in-customer-journey-analytics.md)
    + [Utiliser des segments en tant que dimensions](components/filters/use-filters-as-dimensions.md)
    + [Créer des audiences à partir de segments](components/filters/create-audiences-from-segments.md)
    ...
    + [Segmentation au niveau de l’objet à l’aide de sous-événements](components/filters/object-level-segmentation-using-sub-events.md)
  + [Reporting en temps réel](components/real-time-reporting.md)
...
+ Export {#exporting}
  ...
  + [Administrer et gérer les exportations de tables complètes](exporting/manage-full-table-exports.md)
...
+ Intégration de la plateforme d’expérience {#experience-platform-integration}
...
+ Cas d’utilisation {#use-cases}
  + Intelligence artificielle {#ai}
    + [Suivre et analyser le trafic IA](use-cases/ai/track-and-analyze-ai-traffic.md)
    + [Valider la qualité du jeu de données avec Data Engineering Agent](use-cases/ai/validate-dataset-quality-data-engineering-agent.md)
  + Cas dʼutilisation des vues de données {#data-views-use-cases}
    + [Rapports sur les premières sessions et les sessions récurrentes](use-cases/data-views-use-cases/first-time-and-returning-sessions.md)
